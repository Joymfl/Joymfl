...
- ⚙️ **Low-level systems** – runtimes, job systems, schedulers, concurrency primitives  
- 🧬 **Solana & on-chain programs** – parallel execution, account models, safety tooling  
- 🎮 **Rendering & engines** – custom Vulkan-based engine, GPU compute, spatial data structures  
- 🌐 **Backends** – real-time services, distributed workers, observability, infra automation  
- 🖥️ **Developer tools & visualizers** – shader sandboxes, system visualizations, CLIs

---

### 🚀 Highlighted projects

> I’m progressively open-sourcing more of my work, from my local git server. A few things I’m focusing on:
...
- **Distributed Job Scheduler**  
  A small but serious distributed worker system: task leasing, retries, priorities, and metrics — designed as a learning playground for building robust backends.
...
(Once these repos are public, I’ll pin them below.)
...
If you’re working on low-level systems, engines, or high-performance Solana / backend infra and want to chat or collaborate, feel free to reach out.

<!-- Add links once ready:
- 🕸️ Website: https://your-domain.dev
